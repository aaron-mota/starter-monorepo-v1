...
interface GetManyLimitedFieldsArgs<
...
export const getManyLimitedFieldsFn = async function getManyLimitedFieldsFn<
  T extends ZodObject<ZodRawShape>,
  C extends ZodObject<ZodRawShape>,
  U extends ZodObject<ZodRawShape>,
  TDb extends ZodObject<ZodRawShape>,
  CDb extends ZodObject<ZodRawShape>,
  UDb extends ZodObject<ZodRawShape>,
>({ db: dbArg, config, adapterFns, input }: GetManyLimitedFieldsArgs<T, C, U, TDb, CDb, UDb>): Promise<z.infer<T>[]> {
